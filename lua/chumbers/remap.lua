...
-- Diagnostic keymaps
vim.keymap.set("n", "dk", vim.diagnostic.jump({count=-1, float=true}), { desc = "Go to previous diagnostic message" })
vim.keymap.set("n", "dj", vim.diagnostic.jump({count=1, float=true}), { desc = "Go to next diagnostic message" })
