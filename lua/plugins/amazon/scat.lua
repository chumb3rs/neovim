return {
    ...
    config = function()
        ...
        scat.setup {
            ...
            brazil_workplace_path = "<optional_path_to_root_of_brazil_workplace>"
        }
        ...
        map_key("n", "<leader>arpp", function() cr.fetch_active_crs({ force_pick = true }) end,
        ...
        map_key('n', '<leader>ay', tiny_url.shorten_url)
        map_key('n', '<leader>ais', brazil.lookup_packages, { desc = "Lookup Packages" })
        map_key('n', '<leader>am', quip.publish_quip_document)
