return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "K", vim.lsp.buf.hover, { desc = "Open IntelliSense menu" })
        ...
        vim.keymap.set("n", "<leader>lca", vim.lsp.buf.code_action, { desc = "[L]SP [C]ode [A]ctions" })
        vim.keymap.set("v", "<leader>lca", vim.lsp.buf.code_action, { desc = "[L]SP [C]ode [A]ctions" })
